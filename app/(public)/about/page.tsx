  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 text-slate-600">
        MAP Petro Emirates is an HR recruitment consultancy dedicated to
        connecting skilled professionals with leading employers. We partner
        with organizations across a range of industries to source, screen,
        and place candidates who are the right fit &mdash; both technically
        and culturally.
      </p>
